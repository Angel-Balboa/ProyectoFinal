					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2 font-weight-bold">Fecha de Nacimiento</label>
									<div class="col-md-5">
										<input class="form-control border-green border-2" type="date" name="date" value="30/12/1980">
									</div>
								</div>
